  ...
  return (
    <div className="text-black w-full h-auto flex flex-col justify-between items-center px-4 sm:px-6 md:px-10 py-6">
      <div className="w-full h-auto flex flex-col items-center gap-4 sm:gap-6 md:gap-8">
        ...
        <AnimatedBlock direction="up" className="w-full h-auto mt-6 sm:mt-8 md:mt-10 flex flex-col items-center gap-4 sm:gap-5 bg-white p-4 sm:p-6 md:p-8 rounded-lg">
          {/* Image carousel */}
      ...
      >
        ...
        <div className="w-full md:w-[45%] flex flex-col gap-4 sm:gap-5 md:gap-6">
          ...
          <div className="hidden md:grid md:grid-cols-2 gap-4 sm:gap-6 mt-4 sm:mt-6 md:mt-6">
            {cards.map((card, index) => (
              <AnimatedBlock direction="up" key={index}>
                <div className="p-3 sm:p-4 md:p-5 border-2 border-gray/50 rounded-xl shadow-sm hover:scale-105 hover:shadow-secondary-500 hover:shadow-md ease-in-out duration-300 cursor-pointer">
                  {card.icon}
          ...
          <div className="md:hidden w-full overflow-x-hidden pb-4">
            ...
            >
              {cards.map((card, index) => (
                <AnimatedBlock direction="up" key={index}>
                  <div className="inline-block w-[200px] sm:w-[220px] h-[240px] sm:h-[260px] p-2 sm:p-3 border-2 border-gray/50 rounded-xl shadow-sm hover:scale-105 hover:shadow-secondary-500 hover:shadow-md ease-in-out duration-300 cursor-pointer">
                    {card.icon}
        ...
        {/* Right content (image) */}
        <AnimatedBlock direction="right" className="w-full md:w-[40%] h-[280px] sm:h-[340px] md:h-[600px] flex justify-center items-center bg-gray-100 overflow-hidden mt-4 sm:mt-6 md:mt-36 rounded-3xl">
